...
/** Notifies the admin that a new Google user signed up and is awaiting approval. */
export function buildAdminApprovalEmail(data: { name: string; email: string }): string {
  ...
  <div style="max-width:480px;margin:0 auto">
    ...
    <div style="background:#4f1d96;padding:10px 24px;text-align:center">
      <span style="color:#e9d5ff;font-size:12px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase">
        ✦ Nuevo registro con Google — pendiente de aprobación
      </span>
    </div>
    ...
    <div style="background:#ffffff;padding:28px 24px">
      <p style="margin:0 0 20px;color:#374151;font-size:15px;line-height:1.6">
        Un usuario se registró con Google y está esperando tu aprobación para entrar a <strong>MenuBot</strong>:
      </p>
      ...
      <a href="https://menubot-production.up.railway.app/admin"
        ...
        Aprobar en el panel de Usuarios →
      </a>
    </div>
